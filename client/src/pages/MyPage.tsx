        ...
        <div className="mypage">
            <div className="container">
                <div className="mypage-header">
                    ...
                    <p className="page-description">{user.Name}님의 정보와 활동 현황을 관리할 수 있습니다</p>
                </div>
                                ...
                                {isEditing ? (
                                    <form onSubmit={handleUpdateInfo} className="edit-form">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="input" value={user.Student_ID} disabled />
                                        </div>

                                        <div className="form-group">
                                            <label className="form-label">아이디</label>
                                            <input type="text" className="input" value={user.Login_ID} disabled />
                                        </div>
